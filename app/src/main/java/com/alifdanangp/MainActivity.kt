...
import com.alifdanangp.ui.theme.AlifdanangpTheme
...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.iphone11),
                title = "IPHONE 12",
                subtitle = "Start @",
                header = "$1000",
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.iphone11promax),
                title = "IPHONE 13",
                subtitle = "Discount",
                header = "20%",
...
fun CategorySection() {
    Column(Modifier.padding(horizontal = 16.dp)) {
        ...
        Row(
            ...
            CategoryButton(
                text = "Iphone 12 ",
                icon = painterResource(id = R.drawable.iphone12),
                backgroundColor = Color(0xffFEF4E7)
            )
            CategoryButton(
                text = "Iphone 12 Pro Max ",
                icon = painterResource(id = R.drawable.iphone12promax),
                backgroundColor = Color(0xffF6FBF3)
            )
            CategoryButton(
                text = "Iphone 13",
                icon = painterResource(id = R.drawable.iphone13),
                backgroundColor = Color(0xffFFFBF3)
            )
            CategoryButton(
                text = "Iphone 13 Pro Max",
                icon = painterResource(id = R.drawable.iphone13promax),
...
fun BestSellerItems() {
    LazyRow(
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.iphonexr),
                title = "Iphone 12",
                price = "4.76",
                discountPercent = 20
            )
